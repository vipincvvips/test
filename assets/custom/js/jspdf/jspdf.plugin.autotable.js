...
function getDefaults() {
    ...
    return {
        ...
        pageBreak: 'auto',
        tableWidth: 'auto',
        showHeader: 'firstPage', //firstPage or everyPage
        tableLineWidth: 0,
        tableLineColor: 200,
        // Hooks
...
var Config = (function () {
    ...
    Config.marginOrPadding = function (value, defaultValue, its_first_time) {
...
//        console.log(side);
//        console.log(config_1.Config.marginOrPadding(this.settings.margin, config_1.getDefaults().margin)[side]);
        this.settings.its_first_time++;
        return config_1.Config.marginOrPadding(this.settings.margin, config_1.getDefaults().margin, this.settings.its_first_time)[side];
    };
    return Table;
}());
exports.Table = Table;
